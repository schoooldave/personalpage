...
const zhSiteContent: SiteContent = {
  ...
  personalHero: {
    ...
    title: "在现实里生活，\n也给自己保留一点",
    emphasis: "自由",
    body: "阅读与钢琴，是对内在世界的持续探索。生活不只有既定答案，也可以在现实与理想之间寻找新的可能。借助 AI，越来越多想法开始走向行动，一个属于自己的世界也在慢慢成形。",
...
const enSiteContent: SiteContent = {
  ...
  personalHero: {
    ...
    emphasis: "freedom",
    body: "Reading and piano are ways of continually exploring the inner world. Life offers more than predetermined answers; new possibilities can emerge between reality and ideals. With AI, more ideas are beginning to become action, and a world of one's own is gradually taking shape.",
    scroll: "SCROLL / FOLLOW THE ORBIT ↓",
    toggle: "Switch view",
  },
  personalWorld: {
...
const jaSiteContent: SiteContent = {
  ...
  personalHero: {
    ...
    title: "現実を生きながら、\n自分の中に少しの",
    emphasis: "自由",
    body: "読書とピアノは、内なる世界を探り続けるためのもの。人生には決められた答えだけでなく、現実と理想の間に新しい可能性を見つける余地があります。AI の力でより多くのアイデアが行動へと変わり、自分だけの世界が少しずつ形になっています。",
    scroll: "SCROLL / FOLLOW THE ORBIT ↓",
    toggle: "視点を切り替える",
  },
  personalWorld: {
